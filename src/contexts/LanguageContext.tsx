...
export const translations = {
  en: {
    dir: "ltr" as const,
    hero: {
      date: "April 17–18, 2026 · Hassiba Ben Bouali University · On-Site",
    ...
    countdown: {
      ...
      regDate: "15 April, 2026", hackDate: "17 April, 2026",
    ...
    timeline: {
      title: "Timeline",
      events: [
        { label: "Registration Opens", date: "5 April, 2026" },
        { label: "Registration Deadline", date: "15 April, 2026" },
    ...
    location: {
      ...
      name: "Mobilis Campus",
      address: "Address",
      addressVal: "Mobilis Headquarters, Algeria",
    ...
    faq: {
      title: "FAQ",
      questions: [
        { q: "Who can participate in BrainHack 2026?", a: "BrainHack is open to all university students from any major or year. Whether you're a developer, designer, or business thinker — if you have a passion for solving real-world problems, you're welcome to join. Teams can have 2–5 members." },
        { q: "Do I need prior experience in programming?", a: "Not necessarily! BrainHack values diverse skills. While technical skills help, we also need designers, product managers, and creative problem-solvers. Mentors will be on-site throughout the event to guide you." },
        { q: "What should I bring to the hackathon?", a: "Bring your laptop, charger, and any hardware you might need. The venue will provide internet, power, and meals throughout the 27-hour sprint. Most importantly, bring your ideas, energy, and team spirit!" },
      ],
    ...
    enroll: {
      ...
      closedMsg: "The registration window closed on April 15, 2026. Thank you for your interest — stay tuned for the next edition!",
  ...
  fr: {
    dir: "ltr" as const,
    hero: {
      date: "17–18 Avril 2026 · Université Hassiba Ben Bouali · Sur site",
    ...
    countdown: {
      ...
      regDate: "15 Avril, 2026", hackDate: "17 Avril, 2026",
    ...
    timeline: {
      title: "Calendrier",
      events: [
        { label: "Ouverture des inscriptions", date: "5 Avril, 2026" },
        { label: "Clôture des inscriptions", date: "15 Avril, 2026" },
    ...
    faq: {
      title: "FAQ",
      questions: [
        { q: "Qui peut participer à BrainHack 2026 ?", a: "BrainHack est ouvert à tous les étudiants universitaires, quelle que soit leur filière ou leur année. Les équipes peuvent avoir 2 à 5 membres." },
        { q: "Ai-je besoin d'une expérience préalable en programmation ?", a: "Pas nécessairement ! BrainHack valorise des compétences diverses. Des mentors seront présents tout au long de l'événement pour vous guider." },
        { q: "Que dois-je apporter au hackathon ?", a: "Apportez votre ordinateur portable, chargeur et tout matériel dont vous pourriez avoir besoin. Le lieu fournira Internet, l'électricité et les repas." },
      ],
    ...
    enroll: {
      ...
      closedMsg: "La période d'inscription s'est terminée le 15 avril 2026. Merci de votre intérêt !",
  ...
  ar: {
    dir: "rtl" as const,
    hero: {
      date: "١٧–١٨ أبريل ٢٠٢٦ · جامعة حسيبة بن بوعلي · حضوري",
      by: "بواسطة", enrollNow: "سجّل الآن",
      question: "هل لديك سؤال؟", clickAsk: "انقر هنا",
    },
    sponsors: { title: "رعاة الحدث" },
    countdown: {
      title: "العد التنازلي", regEnds: "نهاية التسجيل خلال",
      hackStart: "انطلاق الهاكاثون خلال", days: "أيام", hours: "ساعات",
      minutes: "دقائق", seconds: "ثواني",
      regDate: "١٥ أبريل ٢٠٢٦", hackDate: "١٧ أبريل ٢٠٢٦",
    ...
    about: {
      ...
      stats: [
        { value: "٣٦", label: "مشاركًا", desc: "من أفضل العقول الإبداعية" },
    ...
    timeline: {
      title: "الجدول الزمني",
      events: [
        { label: "بداية التسجيل", date: "٥ أبريل ٢٠٢٦" },
        { label: "نهاية التسجيل", date: "١٥ أبريل ٢٠٢٦" },
    ...
    faq: {
      ...
      questions: [
        { q: "من يمكنه المشاركة في BrainHack 2026؟", a: "BrainHack مفتوح لجميع طلاب الجامعات من أي تخصص أو سنة. يمكن أن تضم الفرق من ٢ إلى ٥ أعضاء." },
        { q: "هل أحتاج إلى خبرة مسبقة في البرمجة؟", a: "ليس بالضرورة! يقدّر BrainHack المهارات المتنوعة. سيتواجد المرشدون طوال الحدث لتوجيهك." },
        { q: "ماذا يجب أن أحضر إلى الهاكاثون؟", a: "أحضر حاسوبك المحمول وشاحنه. سيوفر المكان الإنترنت والكهرباء والوجبات طوال سباق ٢٧ ساعة." },
      ],
    ...
    enroll: {
      ...
      back: "رجوع",
      fullName: "الاسم الكامل", fullNamePh: "مثال: أحمد بن علي",
      email: "البريد الإلكتروني", emailPh: "you@example.com",
      phone: "رقم الهاتف", phonePh: "مثال: 0555 123 456",
      regNumber: "رقم التسجيل", regNumberPh: "مثال: 20230001",
      level: "المستوى الدراسي", levelPh: "اختر مستواك",
      speciality: "التخصص", specialityPh: "اختر تخصصك",
      portfolio: "رابط المحفظة", portfolioPh: "مثال: https://github.com/username",
      optional: "اختياري",
      submit: "إرسال التسجيل",
      submitting: "جارٍ الإرسال...",
      closedTitle: "انتهى التسجيل",
      closedMsg: "انتهت فترة التسجيل في ١٥ أبريل ٢٠٢٦. شكرًا لاهتمامك!",
