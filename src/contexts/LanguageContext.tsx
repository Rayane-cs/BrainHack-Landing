...
export const translations = {
  en: {
    ...
    enroll: {
      ...
      notStartedMsg: "Registration for BrainHack 2026 will open on April 5, 2026. Stay tuned!",
  ...
  fr: {
    ...
    enroll: {
      ...
      notStartedMsg: "L'inscription pour BrainHack 2026 ouvrira le 5 avril 2026. Restez à l'écoute !",
  ...
  ar: {
    ...
    enroll: {
      ...
      notStartedMsg: "سيفتح باب التسجيل لـ BrainHack 2026 في ٥ أبريل، ٢٠٢٦. كن في الموعد!",
