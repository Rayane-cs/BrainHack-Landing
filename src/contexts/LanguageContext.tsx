...
export const translations = {
  en: {
    ...
    enroll: {
      ...
      townName: "Town / city name", townNamePh: "e.g. Chlef",
      stopStation: "Stop station name", stopStationPh: "e.g. Main stop station",
      transportHintTitle: "Please type these carefully",
      transportHintBody:
        "Enter your town and stop station name exactly as they should be used. If a bus or shuttle is organized, we rely on these details for your return trip too — mistakes can affect your pickup.",
      optional: "optional",
    ...
    modal: {
      ...
      transportNoticeTitle: "Transport is not confirmed yet",
      transportNotice:
        "Shuttle or bus transport is not confirmed yet. When a decision is made, we will email you to tell you clearly whether your transport is confirmed or not.",
  ...
  fr: {
    ...
    enroll: {
      ...
      townName: "Ville / commune", townNamePh: "ex. Chlef",
      stopStation: "Nom de la station d’arrêt", stopStationPh: "ex. Station d’arrêt principale",
      transportHintTitle: "Merci de bien saisir ces champs",
      transportHintBody:
        "Indiquez la ville et le nom de la station d’arrêt exactement comme ils doivent apparaître. Si un bus ou une navette est organisé, nous utilisons ces informations aussi pour le retour — une erreur peut affecter votre prise en charge.",
      optional: "facultatif",
    ...
    modal: {
      ...
      transportNoticeTitle: "Le transport n’est pas encore confirmé",
      transportNotice:
        "Le transport (bus ou navette) n’est pas encore confirmé. Dès qu’une décision est prise, nous vous enverrons un e-mail pour vous indiquer clairement si votre transport est confirmé ou non.",
  ...
  ar: {
    ...
    enroll: {
      ...
      townName: "اسم البلدة / المدينة", townNamePh: "مثال: الشلف",
      stopStation: "اسم محطة التوقف", stopStationPh: "مثال: المحطة الرئيسية",
      transportHintTitle: "يرجى إدخال هذين الحقلين بدقة",
      transportHintBody:
        "اكتب اسم البلدة واسم محطة التوقف كما يجب أن يظهرا بالضبط. إذا تم تنظيم حافلة أو نقل، نعتمد على هذه البيانات لرحلة العودة أيضًا — أي خطأ قد يؤثر على استلامك.",
      optional: "اختياري",
      submit: "إرسال",
    ...
    modal: {
      ...
      transportNoticeTitle: "النقل غير مؤكد بعد",
      transportNotice:
        "لم يُؤكَّد بعد توفير حافلة أو نقل جماعي. عند اتخاذ القرار سنرسل إليك بريداً إلكترونياً لنوضح لك صراحةً إن كان النقل مؤكداً لك أم لا.",
