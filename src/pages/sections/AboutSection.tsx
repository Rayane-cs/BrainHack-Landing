    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 px-4">
        ...
        <div className="relative lg:col-span-2 md:col-span-2 flex items-center h-[12.5rem] md:h-[15rem] border-[3px] border-[#3ed2ff] rounded-3xl bg-gradient-to-r from-[#3ed2ff30] to-transparent shadow-[0_0_20px_rgba(62,210,255,0.15)] transition-transform duration-300 hover:scale-[1.02] stagger-1 overflow-visible">
          <span className="absolute -left-6 -bottom-16 text-[220px] md:text-[280px] font-bold text-white/[0.04] leading-none select-none pointer-events-none blur-sm z-0">36</span>
          <div className="relative z-10 flex w-full h-full rounded-3xl overflow-hidden">
            <div className="flex flex-col justify-center items-start text-left p-8 md:p-12 w-[60%] z-20">
              <span className="text-[#fafdff] text-7xl md:text-[90px] font-bold leading-none mb-2 z-20">36</span>
              <span className="text-[#3ed2ff] text-2xl md:text-3xl font-bold mb-1 capitalize tracking-wide z-20">Participant</span>
              <p className="text-[#7fa6bd] text-sm leading-snug font-poppins opacity-90 z-20">{t.about.stats[0]?.desc}</p>
            </div>
          </div>
          <div className="absolute right-[10px] md:right-[-20px] top-1/2 -translate-y-1/2 w-[140px] md:w-[250px] z-30 pointer-events-none">
        ...
        <div className="relative lg:row-span-2 flex items-center justify-center min-h-[18.75rem] mt-[40px] lg:mt-0 lg:min-h-[31.25rem] border-[3px] border-[#3ed2ff] rounded-[30px] bg-gradient-to-t from-[#3ed2ff40] to-transparent shadow-[0_0_20px_rgba(62,210,255,0.15)] transition-transform duration-300 hover:scale-[1.02] stagger-4 overflow-visible">
          <span className="absolute left-[-10px] md:-left-[20px] lg:-left-[10px] -bottom-[40px] lg:-bottom-[60px] text-[300px] lg:text-[450px] font-bold text-white/[0.08] leading-none select-none pointer-events-none z-0 tracking-tighter">1</span>
          <div className="relative z-10 flex flex-col justify-end w-full h-full p-8 lg:p-10 lg:pb-12 text-center rounded-[30px] overflow-hidden">
            <div className="z-20 mt-auto pt-[40px]">
              <span className="text-[#3ed2ff] text-[40px] md:text-[50px] font-bold capitalize tracking-tighter block mb-1 font-[Oughter-Regular]">Winner</span>
        ...
        <div className="relative flex items-center h-[200px] md:h-[240px] border-[3px] border-[#3ed2ff] rounded-3xl bg-gradient-to-t from-[#3ed2ff30] to-transparent shadow-[0_0_20px_rgba(62,210,255,0.15)] transition-transform duration-300 hover:scale-[1.02] stagger-2 overflow-visible mt-8 md:mt-0 lg:mt-0">
          <span className="absolute -left-6 -bottom-6 text-[200px] md:text-[260px] font-bold text-white/[0.04] leading-none select-none pointer-events-none blur-sm z-0">2</span>
          <div className="relative z-10 flex flex-col justify-end items-start text-left p-8 md:p-10 w-full h-full rounded-3xl overflow-hidden">
            <span className="text-[#fafdff] text-6xl md:text-7xl font-bold leading-none mb-1 md:mb-2 z-20">2</span>
            <span className="text-[#3ed2ff] text-2xl md:text-3xl font-bold capitalize z-20">Category</span>
            <p className="text-[#7fa6bd] text-sm leading-snug font-poppins opacity-90 z-20 mt-1">{t.about.stats[1]?.desc}</p>
          </div>
          <div className="absolute -top-[20px] md:-top-[30px] right-[-10px] md:right-[-20px] w-[130px] md:w-[110px] z-30 pointer-events-none">
        ...
        <div className="relative flex items-center h-[200px] md:h-[240px] border-[3px] border-[#3ed2ff] rounded-3xl bg-gradient-to-t from-[#3ed2ff30] to-transparent shadow-[0_0_20px_rgba(62,210,255,0.15)] transition-transform duration-300 hover:scale-[1.02] stagger-3 overflow-visible mt-8 md:mt-0 lg:mt-0">
          <span className="absolute -left-6 -bottom-6 text-[180px] md:text-[220px] font-bold text-white/[0.04] leading-none select-none pointer-events-none blur-sm z-0">27</span>
          <div className="relative z-10 flex flex-col justify-end items-start text-left p-8 md:p-10 w-full h-full rounded-3xl overflow-hidden">
            <span className="text-[#fafdff] text-6xl md:text-7xl font-bold leading-none mb-1 md:mb-2 z-20">27</span>
            <span className="text-[#3ed2ff] text-2xl md:text-3xl font-bold capitalize z-20">Hours</span>
            <p className="text-[#7fa6bd] text-sm leading-snug font-poppins opacity-90 z-20 mt-1">{t.about.stats[2]?.desc}</p>
          </div>
          <div className="absolute -top-[20px] md:-top-[30px] -right-[10px] md:-right-[20px] w-[120px] md:w-[110px] z-30 pointer-events-none">
